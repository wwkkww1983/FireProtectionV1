...
<template>
    <div class="editReBox">
           <topBack :title="$route.name" symbol="lawyLog" :from="fromPath"></topBack> 
           <topHome></topHome>
           <!--  -->
           <div class="topNav">
                            ...
                            <div class="topFill">
                                ...
                                <div class="checkResult">
                                    ...
                                    <div class="selectResult">
                                      ...
                                      <span class="" v-if="checkResult == -1">现场改正</span>
                                      <span class="ff8400" v-if="checkResult == -2">限期整改</span>
                                      <span class="ff0000" v-if="checkResult == -3">停业整顿</span>
                                    </div>
                                </div>
                            </div>
                            <!-- 下发法律文书 -->
            ...
            <mt-popup v-model="messageVisible" position="bottom" pop-transition="popup-fade">
                <div class="popupBox">
                    ...
                    <div class="popupContainer">
                        <div class="isTrue">
                            <span>是否合格：</span>
                            <span style=""  v-if="value == true">合格</span>
                            <span style="color:#ff8400;" v-if="value == false">不合格</span>
                        </div>
                        <textarea style="color: #989898;" readonly  v-model="lawyTextarea" placeholder="在这里输入存在的问题" name="isTrueTextarea" id="" cols="30" rows="10"></textarea>
                    </div>
                </div>
            </mt-popup>
        ...
        this.$http({
           ...
           params:{
            ...
            if(res.status == 200){
                ...
                let index =  res.data.result.creationTime.lastIndexOf(":");
                let newarr =  res.data.result.creationTime.slice(0,index);
                res.data.result.creationTime = newarr
